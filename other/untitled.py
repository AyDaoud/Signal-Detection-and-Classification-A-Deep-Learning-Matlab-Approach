...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.list_var = list_var = [1 , 2 , 3]
        self.samp_rate = samp_rate = 32000
        self.list_compre = list_compre = [(i+1) for i in list_var]
    ...
    def set_list_var(self, list_var):
        self.list_var = list_var
        self.set_list_compre([(i+1) for i in self.list_var])
    ...
    def get_list_compre(self):
        return self.list_compre

    def set_list_compre(self, list_compre):
        self.list_compre = list_compre
